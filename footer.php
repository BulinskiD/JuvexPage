...
<<<<<<< HEAD
   			<strong>tel. <a style="text-decoration: none; color: #17A1A5;" href="tel:<?php echo get_option('tel'); ?>"><?php echo get_option('tel'); ?></a></strong>
   	</span>
   		<span class="fb"><a href="https://www.facebook.com/KursyNaukaJazdy/" target="_blank"><img src="<?php  echo get_template_directory_uri(); ?>/images/f-ogo_RGB_HEX-100.svg" alt="facebook logo" style="height:100%;" /></a></span>
=======
